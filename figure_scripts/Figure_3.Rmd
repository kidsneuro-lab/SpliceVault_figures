...
addWorksheet(wb, "figure_3A")
writeData(wb, "figure_3A", as.data.frame(plotdatA), startRow = 1, startCol = 1)
...
addWorksheet(wb, "figure_3B")
writeData(wb, "figure_3B", as.data.frame(conc_plot), startRow = 1, startCol = 1)
...
plotdatC = splicevault_ts_dg[TISSUE!='', .(sj_pos_key, sj_event_key, TISSUE, tissue_sample_count, gtex_sample_count)] %>%
...
addWorksheet(wb, "figure_3C")
writeData(wb, "figure_3C", as.data.frame(plotdatC), startRow = 1, startCol = 1)
...
addWorksheet(wb, "figure_3D")
writeData(wb, "figure_3D", as.data.frame(fromList(listInput)), startRow = 1, startCol = 1)

```

```{r}
saveWorkbook(wb, file = "../figs/source_data/source_data_fig_3.xlsx", overwrite = TRUE)
